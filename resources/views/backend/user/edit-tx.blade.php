    ...
    <section class="content">
        <div class="row">
            ...
            <div class="card">
                ...
                <!-- Start Card Body -->
                <div class="card-body"> 
                    <form role="form" action="{{URL::to('/update-tx/'.$edit->phone)}}" method="POST">
                        @csrf
                       ...
                       <div class="form-group row">
                        ...
                        <select class="form-control" id="exampleformControlSelect1" name="payment_description" required>
                            ...
                            <option value="MWAK Membership Fees" {{'MWAKFee' == $edit->payment_description ? 'selected' : ''}}>MWAK Membership Fees</option>
                            <option value="Membership Card Fees" {{'CardFee' == $edit->payment_description ? 'selected' : ''}}>Membership Card Fees</option>

                    ...
                    <div class="card-body">
                        <form role="form" action="{{ URL::to('upload-docs') }}" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control datetimepicker" name="event_start" id="event_start" placeholder="Select Event Start Date" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control datetimepicker" name="event_end" id="event_end" placeholder="Select Event End Date" required>
                                </div>
                            </div>
